...
const Dwonlode = ({ downlode }) => {
    const { title, id, image, ratingAvg, downloads, size } = downlode;
        ...
        <div className="mx-auto p-4">
            <div className="grid grid-cols-1 sm:grid-cols-[auto_1fr_auto] items-center gap-4 p-5 bg-white border border-gray-100 rounded-xl shadow-sm">
                ...
                <div className="flex justify-center sm:justify-end">
                    <button className="w-full sm:w-auto px-8 py-2.5 bg-[#00dc94] hover:bg-[#00c584] text-white font-bold rounded-lg transition-colors">
                        Uninstall
                    </button>
                </div>
            </div>
