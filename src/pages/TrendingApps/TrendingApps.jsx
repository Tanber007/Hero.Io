        ...
        <>
            <section className='mt-15 w-11/12 mx-auto'>
                <div className='text-center items-center my-6'>
                    <h2 className="text-3xl sm:text-5xl font-bold mb-12 sm:mb-16 tracking-tight">Trending Apps</h2>
                ...
                <div className="w-11/12 mx-auto items-center text-center my-5">
                    <button className='textarea-sm sm:text-xl font-semibold bg-gradient-to-r from-[#632EE3] to-[#9F62F2] px-3 py-1 sm:px-6 py-3 rounded-xl'>Show All</button>
                </div>
            </section>
        </>
    );
